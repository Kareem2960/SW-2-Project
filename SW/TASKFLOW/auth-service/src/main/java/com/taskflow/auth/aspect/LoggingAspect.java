package com.taskflow.auth.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.taskflow.auth.controller..*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(* com.taskflow.auth.service..*(..))")
    public void serviceMethods() {}

    @Pointcut("execution(* com.taskflow.auth.repository..*(..))")
